...
{
    public class StationNO2Now : jsairSrcUrl
    {

        #region 静态变量

        private static string tag = "StationNO2Now";
        private static string name = "江苏所有站点1小时NO2";
        private static string url = "http://218.94.78.75:20001/JSAQPPSERVICES/REST/V100/STATION/{0}/NO2/NOW?token={1}";
