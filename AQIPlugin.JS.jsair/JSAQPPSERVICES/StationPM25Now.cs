...
{
    public class StationPM25Now : jsairSrcUrl
    {

        #region 静态变量

        private static string tag = "StationPM25Now";
        private static string name = "江苏所有站点1小时PM25";
        private static string url = "http://218.94.78.75:20001/JSAQPPSERVICES/REST/V100/STATION/{0}/PM25/NOW?token={1}";
