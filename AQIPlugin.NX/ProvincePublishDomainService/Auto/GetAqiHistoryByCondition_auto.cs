...
{
    public class GetAqiHistoryByCondition_Auto : NXSrcUrl_Param, IParseSrcUrlParam
    {

        #region 静态变量

        private static string tag = "GetAqiHistoryByCondition_Auto";
        private static string name = "宁夏站点24小时历史AQI";
        private static string url = "http://119.60.12.114:8080/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetAqiHistoryByCondition";
