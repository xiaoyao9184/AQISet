...
{
    public class GetAqiCityStation : AHSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetAqiCityStation";
        private static string name = "安徽城市站点列表";
        private static string url = "http://www.ahemc.cn:8016/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetAqiCityStation";
