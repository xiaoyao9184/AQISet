...
{
    public class GetCityAqiByCityName : JLSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetCityAqiByCityName";
        private static string name = "吉林城市1小时AQI";
        private static string url = "http://58.245.27.140:82/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetCityAqiByCityName";
