...
namespace LN.Ajax
{
    public class GetPM10 : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "GetPM10";
        private static string name = "站点24小时PM10";
        private static string url = "http://211.137.19.74:8089/Ajax/GetPM10";
