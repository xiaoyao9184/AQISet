...
{
    public class yanan7Day : sxAQIWebSrcUrl
    {

        #region 静态变量

        private static string tag = "yanan7Day";
        private static string name = "西安市7天AQI";
        private static string url = "http://113.140.66.226:8024/sxAQIWeb/swfPage/yanan7Day.xml";
