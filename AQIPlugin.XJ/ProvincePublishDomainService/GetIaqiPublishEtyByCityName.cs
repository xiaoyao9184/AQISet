...
{
    public class GetIaqiPublishEtyByCityName : XJSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetIaqiPublishEtyByCityName";
        private static string name = "新疆城市站点1小时AQI";
        private static string url = "http://124.88.62.18:82/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetIaqiPublishEtyByCityName";
