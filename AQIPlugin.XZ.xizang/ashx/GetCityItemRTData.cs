...
{
    public class GetCityItemRTData : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "GetCityItemRTData";
        private static string name = "西藏城市1小时AQI";
        private static string url = "http://111.11.241.103:9001/ashx/GetCityItemRTData.ashx";
