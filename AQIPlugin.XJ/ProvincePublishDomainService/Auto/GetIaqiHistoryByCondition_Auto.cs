...
using AQI.Interface;
using XJ.ProvincePublishDomainService;
using System.Xml.Linq;
using System.IO;

namespace XJ.ProvincePublishDomainService.Auto
{
    public class GetIaqiHistoryByCondition_Auto : XJSrcUrl_Param, IParseSrcUrlParam
    {
