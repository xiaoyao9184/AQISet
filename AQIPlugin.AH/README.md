...
数据接口: http://www.ahemc.cn:8016/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc
...
> 自动获取站点参数（由于GetAqiCityStation接口返回的数据不正常采用GetAQIDataByCityName）
