...
namespace JL.ProvincePublishDomainService.Auto
{
    public class GetAqiHistoryByCondition_Auto : JLSrcUrl_Param, IParseSrcUrlParam
    {

        #region 静态变量

        private static string tag = "GetAqiHistoryByCondition_Auto";
        private static string name = "吉林站点24小时历史AQI";
        private static string url = "http://58.245.27.140:82/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetAqiHistoryByCondition";
