...
namespace FJ.ProvincePublishDomainService.Auto
{
    public class GetAqiHistoryByCondition_Auto : FJSrcUrl_Param, IParseSrcUrlParam
    {

        #region 静态变量

        private static string tag = "GetAqiHistoryByCondition_Auto";
        private static string name = "福建站点24小时历史AQI";
        private static string url = "http://fbpt.fjemc.org.cn/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetAqiHistoryByCondition";
