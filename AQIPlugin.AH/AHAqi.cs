...
namespace AH
{
    public class AHAqi : ABaseAqiWeb
    {

        #region 静态字段

        private static string name = "安徽空气质量实时发布系统";
        private static string tag = "ah";
        private static string url = "http://www.ahemc.cn:8016/";
        ...
        private static string[] srcNameSpace = new string[]{
            "AH.ProvincePublishDomainService", "AH.ProvincePublishDomainService.Auto"
        };
