...
namespace LN.Ajax
{
    public class GetSO2 : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "GetSO2";
        private static string name = "站点24小时SO2";
        private static string url = "http://211.137.19.74:8089/Ajax/GetSO2";
