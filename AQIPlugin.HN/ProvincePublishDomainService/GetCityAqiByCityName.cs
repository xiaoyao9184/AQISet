...
{
    public class GetCityAqiByCityName : HNSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetCityAqiByCityName";
        private static string name = "湖南城市1小时AQI";
        private static string url = "http://222.247.51.155:8025/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetCityAqiByCityName";
