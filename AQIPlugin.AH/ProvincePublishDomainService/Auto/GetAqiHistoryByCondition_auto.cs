...
{
    public class GetAqiHistoryByCondition_Auto : AHSrcUrl_Param, IParseSrcUrlParam
    {

        #region 静态变量

        private static string tag = "GetAqiHistoryByCondition_Auto";
        private static string name = "安徽站点24小时历史AQI";
        private static string url = "http://www.ahemc.cn:8016/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetAqiHistoryByCondition";
