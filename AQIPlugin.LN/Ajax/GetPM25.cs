...
namespace LN.Ajax
{
    public class GetPM25 : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "GetPM25";
        private static string name = "站点24小时PM25";
        private static string url = "http://211.137.19.74:8089/Ajax/GetPM25";
