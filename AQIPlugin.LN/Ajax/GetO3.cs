...
namespace LN.Ajax
{
    public class GetO3 : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "GetO3";
        private static string name = "站点24小时O3";
        private static string url = "http://211.137.19.74:8089/Ajax/GetO3";
