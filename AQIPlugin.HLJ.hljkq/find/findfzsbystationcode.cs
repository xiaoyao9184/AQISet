...
{
    public class findfzsbystationcode : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "findfzsbystationcode";
        private static string name = "黑龙站点？？";
        private static string url = "http://111.40.0.99:8081/hljkq/findfzsbystationcode";
