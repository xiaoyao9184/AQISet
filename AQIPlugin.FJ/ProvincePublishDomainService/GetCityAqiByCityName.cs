...
{
    public class GetCityAqiByCityName : FJSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetCityAqiByCityName";
        private static string name = "福建城市1小时AQI";
        private static string url = "http://fbpt.fjemc.org.cn/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetCityAqiByCityName";
