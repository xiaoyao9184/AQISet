...
{
    public class GetAQIDataByCityName : HNSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetAQIDataByCityName";
        private static string name = "湖南城市站点1小时浓度";
        private static string url = "http://222.247.51.155:8025/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetAQIDataByCityName";
