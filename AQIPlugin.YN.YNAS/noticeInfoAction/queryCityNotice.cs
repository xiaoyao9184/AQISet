...
namespace YNAS.noticeInfoAction
{
    public class queryCityNotice : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "queryCityNotice";
        private static string name = "云南通知";
        private static string url = "http://61.166.240.109:6013/YNAS/noticeInfoAction!queryCityNotice";
