...
数据接口地址为http://www.ahemc.cn:8016/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc
...
由于与站点相关的数据参数太多，故增加自动化接口自动获取站点参数（由于GetAqiCityStation接口返回的数据不正常采用GetAQIDataByCityName）

名称									解释
============================================================
GetAqiHistoryByCondition_Auto			参数从GetAQIDataByCityName接口获得
GetIaqiHistoryByCondition_Auto			参数从GetAQIDataByCityName接口获得
