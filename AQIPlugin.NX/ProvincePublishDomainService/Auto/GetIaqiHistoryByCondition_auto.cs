...
using AQI.Interface;
using NX.ProvincePublishDomainService;
using System.Xml.Linq;
using System.IO;

namespace NX.ProvincePublishDomainService.Auto
{
    public class GetIaqiHistoryByCondition_Auto : NXSrcUrl_Param, IParseSrcUrlParam
    {

        #region 静态变量

        private static string tag = "GetIaqiHistoryByCondition_Auto";
        private static string name = "宁夏站点24小时历史浓度";
        private static string url = "http://119.60.12.114:8080/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetIaqiHistoryByCondition";
