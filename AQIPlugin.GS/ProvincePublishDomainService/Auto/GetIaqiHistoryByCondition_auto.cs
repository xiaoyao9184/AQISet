...
using AQI.Interface;
using GS.ProvincePublishDomainService;
using System.Xml.Linq;
using System.IO;

namespace GS.ProvincePublishDomainService.Auto
{
    public class GetIaqiHistoryByCondition_Auto : GSSrcUrl_Param, IParseSrcUrlParam
    {

        #region 静态变量

        private static string tag = "GetIaqiHistoryByCondition_Auto";
        private static string name = "甘肃站点24小时历史浓度";
        private static string url = "http://61.178.102.124:82/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetIaqiHistoryByCondition";
