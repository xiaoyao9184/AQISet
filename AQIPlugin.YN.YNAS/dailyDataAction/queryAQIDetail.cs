...
{
    public class queryAQIDetail : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "queryAQIDetail";
        private static string name = "云南站点24小时AQI等级";
        private static string url = "http://61.166.240.109:6013/YNAS/dailyDataAction!queryAQIDetail";
