...
{
    public class GetAQIDataByCityName : JLSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetAQIDataByCityName";
        private static string name = "吉林城市站点1小时浓度";
        private static string url = "http://58.245.27.140:82/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetAQIDataByCityName";
