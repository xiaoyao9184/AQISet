...
namespace LN.Ajax
{
    public class GetCO : AParamSrcUrl
    {

        #region 静态变量

        private static string tag = "GetCO";
        private static string name = "站点24小时CO";
        private static string url = "http://211.137.19.74:8089/Ajax/GetCO";
