...
{
    public class StationO31Now : jsairSrcUrl
    {

        #region 静态变量

        private static string tag = "StationO31Now";
        private static string name = "江苏所有站点1小时O3";
        private static string url = "http://218.94.78.75:20001/JSAQPPSERVICES/REST/V100/STATION/{0}/O31/NOW?token={1}";
