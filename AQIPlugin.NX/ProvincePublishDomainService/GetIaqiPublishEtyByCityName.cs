...
{
    public class GetIaqiPublishEtyByCityName : NXSrcUrl_Param
    {

        #region 静态变量

        private static string tag = "GetIaqiPublishEtyByCityName";
        private static string name = "宁夏城市站点1小时AQI";
        private static string url = "http://119.60.12.114:8080/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetIaqiPublishEtyByCityName";
