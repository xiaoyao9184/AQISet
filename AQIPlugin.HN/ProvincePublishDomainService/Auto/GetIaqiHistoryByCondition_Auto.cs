...
using AQI.Interface;
using HN.ProvincePublishDomainService;
using System.Xml.Linq;
using System.IO;

namespace HN.ProvincePublishDomainService.Auto
{
    public class GetIaqiHistoryByCondition_Auto : HNSrcUrl_Param, IParseSrcUrlParam
    {

        #region 静态变量

        private static string tag = "GetIaqiHistoryByCondition_Auto";
        private static string name = "湖南站点24小时历史浓度";
        private static string url = "http://222.247.51.155:8025/ClientBin/Env-Publish-Province-RiaService-ProvincePublishDomainService.svc/binary/GetIaqiHistoryByCondition";
