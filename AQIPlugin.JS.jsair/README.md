...
数据接口: http://218.94.78.75:20001/jsair/
...
# 泛型接口（逻辑增加）
  + LSZDSB 接口可以按照时间查询历史数据
    - LSZDSB
    - LSZDSB_Auto 更新间隔变为24小时，参数从JSON和StationAQIDayNow获取（时间范围为当前小时向前推24小时，6个污染物从JSON获取，城市、站点代码从StationAQIDayNow获取）
